...
import foto from "../images/planoypersona.jpg";

function BannerUpFooter() {
  return (
    <section>
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
          <div className="relative h-64 overflow-hidden sm:h-80 lg:h-full">
            <img
              alt="Party"
              src={foto}
              className="absolute rounded-xl opacity-90 inset-0 h-full w-full object-cover"
            />
          </div>
